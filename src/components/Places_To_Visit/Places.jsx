  ...
  return (
    <div>
      <div className="flex xs:justify-center gap-6 mt-10 flex-wrap h-auto mb-14">
        ...
        {tours.slice(0, limit || tours.length).map((places) => (
          <Link key={places.id} to={`/tour/${places.id}`}>
            <div className="place-item flex flex-col gap-4 xs:mb-2 lg:mb-0">
              <div
              ...
              <div>
                <h1 className="font-MosafinSemiBold w-[285px] text-3xl text-transparent bg-gradient-to-b from-mybrown via-mybrown to-[#454545] bg-clip-text text-center">
                  {places.PackageName}
                </h1>
              </div>
            </div>
